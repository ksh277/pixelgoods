    ...
    return (
      <div className={`${config.position} ${className}`}>
        <div className="relative">
          <Button
            className="w-12 h-12 sm:w-12 sm:h-12 rounded-full bg-gradient-to-r from-blue-100 to-blue-200 hover:from-blue-200 hover:to-blue-300 border-2 border-blue-300 shadow-lg transition-all duration-300 hover:scale-110 active:scale-95 p-0 overflow-hidden relative"
